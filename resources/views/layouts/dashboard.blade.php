...
<head>
    ...
    <title>Jual Beli Album & Merch Hinako</title>
...
<body>
    <nav class="navbar bg-black shadow-sm navbar-expand-lg bg-se">
        <div class="container-fluid">
          <a class="navbar-brand ms-4" style="width: 350px; color : white; font-family: 'Lobster', cursive" href="#">Jual Beli Album & Merch Hinako</a>
  ...
  @if(auth()->check())
    ...
    <li class="nav-item">
            <a href="/home" class="nav-link link-dark" aria-current="page">
                <i class="bi bi-house-gear-fill" style="font-size: 1.2rem;"></i>
              Home
            </a>
          </li>
          <li class="nav-item">
            <a href="/peralatan" class="nav-link link-dark" aria-current="page">
                <i class="bi bi-box2-heart" style="font-size: 1.2rem;"></i>
              Data Barang
            </a>
          </li>
          {{-- <li class="nav-item">
            <a href="/barang" class="nav-link link-dark" aria-current="page">
          ...
          {{-- <li class="nav-item">
            <a href="/produksi" class="nav-link link-dark" aria-current="page">

...
Route::get('/barang/create', [BarangController::class, 'addView'])->name('barang.create');
...
//CRUD PRODUKSI
Route::get('/produksi', [ProduksiController::class, 'index'])->name('produksi.index');
Route::get('/produksi/create', [ProduksiController::class, 'addView'])->name('produksi.create');
